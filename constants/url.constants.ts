...
export const URLS_SHORT = {
  ...
  ADMINISTRATION: {
    ...
    USER_APPLICATIONS: 'administration/application',
    USER_APPLICATION_TOKENS: 'administration/application/token',
    ...
    VOUCHER_DEPOSIT: 'administration/voucher/deposit',
    VOUCHER_DEPOSIT_DETAIL: 'administration/voucher/deposit/detail',
...
export const URLS = {
  ...
  ADMINISTRATION: {
    ...
    USER_APPLICATIONS: `/${URLS_SHORT.ADMINISTRATION.USER_APPLICATIONS}`,
    USER_APPLICATION_TOKENS: `/${URLS_SHORT.ADMINISTRATION.USER_APPLICATION_TOKENS}`,
    ...
    VOUCHER_DEPOSIT: `/${URLS_SHORT.ADMINISTRATION.VOUCHER_DEPOSIT}`,
    VOUCHER_DEPOSIT_DETAIL: `/${URLS_SHORT.ADMINISTRATION.VOUCHER_DEPOSIT_DETAIL}`,
